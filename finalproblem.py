...
def doqueries(givenfield,command):
	...
	with con:
		...
		if command == commandR6:
			...
			Bandwidth=0.059 #calculated with the above for loop for the fist 2000 entries of the query
			...
			sns.jointplot(x="Y-J", y="J-H", data=df, kind="kde")
